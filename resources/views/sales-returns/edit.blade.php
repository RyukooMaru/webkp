...
@section('main-content')
    <div class="container-fluid">
        {{-- Judul --}}
        <h1 class="h3 font-weight-bold mb-4">Form Edit Retur Penjualan</h1>

        {{-- Card Form Header --}}
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('sales-returns.update', $header->Trx_Auto) }}" method="POST" id="returnForm">
                    @csrf
                    @method('PUT')
                    <div class="form-row">
                        {{-- Kolom Kiri --}}
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                {{-- <-- masukkan value dari $header->trx_number --}}
                                <input type="text" id="returnNumber" name="trx_number" class="form-control" readonly
                                    value="{{ old('trx_number', $header->trx_number) }}">
                            </div>
                            <div class="form-group">
