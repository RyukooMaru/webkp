        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePembelian" class="collapse" aria-labelledby="headingPembelian"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{-- route('#') --}}">test</a>
                        <a class="collapse-item" href="{{-- route('#') --}}">test</a>
                        <a class="collapse-item" href="{{ route('retur.pembelian.index') }}">Retur Pembelian</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    data-target="#collapseDatakaryawan" aria-expanded="true" aria-controls="collapseDatakaryawan">
                    <i class="fas fa-fw fa-wrench"></i>
