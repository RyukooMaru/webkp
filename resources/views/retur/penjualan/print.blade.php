                ...
                <tr style="border: none;">
                    <td style="width: 50%; border: none; vertical-align: top; padding: 0;">
                        <table style="border: none; width: 100%; margin: 0; border-spacing: 0;">
                            <tr style="border: none;">
                                <td style="border: none; width: 120px; padding: 2px 0; margin: 0;"><strong>No.
                                        Retur</strong></td>
                            ...
                            <tr style="border: none;">
                                <td style="border: none; width: 120px; padding: 2px 0; margin: 0;"><strong>Tanggal
                                        Retur</strong></td>
                                <td style="border: none; width: 10px; padding: 2px 0; margin: 0;"><strong>:</strong>
                                </td>
                            ...
                            <tr style="border: none;">
                                <td style="border: none; width: 120px; padding: 2px 0; margin: 0;">
                    ...
                    <td style="width: 50%; border: none; vertical-align: top; text-align: right; padding: 0;">
                        <p style="margin: 5px 0;"><strong>Kode Pelanggan:</strong> {{ $row->Trx_SupCode }}</p>
                    </td>
                </tr>
            </table>
