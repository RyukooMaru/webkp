                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return `
                            <a href="${editUrl}" class="btn btn-sm ${editBtnClass} mb-1" title="Edit" ${editBtnDisabled}>
                                <i class="fas fa-edit"></i>
                            </a>
                            <button data-id="${data}" class="btn btn-sm ${approveBtnClass} btn-approve mb-1" title="Approve" ${approveBtnDisabled}>
                                <i class="fas fa-check"></i>
                            </button>
                            <a href="${printUrl}" class="btn btn-sm btn-info mb-1" title="Print" target="_blank">
